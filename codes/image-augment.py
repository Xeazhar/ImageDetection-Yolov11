...
# Create folder structure: split/class/images and split/class/labels
...
for _, _, class_name in DATASETS:
    ...
    train_folder = os.path.join(OUTPUT_ROOT, 'train', class_name, 'images')
    label_folder = os.path.join(OUTPUT_ROOT, 'train', class_name, 'labels')
    ...
    print(f"Completed augmentations for {class_name}: {total_aug} files created")